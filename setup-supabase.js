...
const REQUIRED_COLUMNS = [
  ...
  ['problem_transformation',      'text',  null],
  ['ideal_customer',              'text',  null],
  ['customer_desire',             'text',  null],
  ['competitors',               'text',  null],
  ['brand_personality',           'text',  null],
  ['positioning',               'text',  null],
  ['launch_context',              'text',  null],
  ['decision_maker',              'text',  null],
  ['decision_maker_other',        'text',  null],
  // Section 02 – Visual Direction
  ['brands_admired',              'text',    null],
  ['color_direction',           'text[]',  null],
  ['color_choice',              'text',    null],
  ['colors_to_avoid',             'text',    null],
  ['aesthetic',                 'text[]',  null],
  ['aesthetic_description',       'text',    null],
  ['existing_assets',             'text',    null],
  ['deliverables',              'text[]',  null],
  ['budget',                    'text',    null],
  ['inspiration_refs',            'text[]',  null],
